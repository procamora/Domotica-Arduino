        ...
        if (resultArrayLength > 0) {
          ...
          for (int i = 0; i < resultArrayLength; i++) {
            ...
            if (last_message_recived != update_id) {
              ...
              String chat_username = root["result"][i]["message"]["chat"]["username"];
              ...
              messages[newMessageIndex].username = chat_username;
...
bool UniversalTelegramBot::sendMessageWithInlineKeyboardMarkup(String chat_id, String text, String parse_mode, String keyboard, bool resize, bool oneTime, bool selective)  {
