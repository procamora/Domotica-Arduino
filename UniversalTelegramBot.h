...
class UniversalTelegramBot
{
  public:
    ...
    bool sendMessageWithInlineKeyboardMarkup(String chat_id, String text, String parse_mode, String keyboard, bool resize = false, bool oneTime = false, bool selective = false);
